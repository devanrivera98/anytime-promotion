...
class MLCore {
    ...
    async verify(fix = false) {
        ...
        for (const rule of tslib_1.__classPrivateFieldGet(this, _MLCore_rules, "f")) {
            ...
            const results = await rule.verify(tslib_1.__classPrivateFieldGet(this, _MLCore_document, "f"), tslib_1.__classPrivateFieldGet(this, _MLCore_locale, "f"), fix).catch(e => {

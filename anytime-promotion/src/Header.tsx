    ...
    <nav className='bg-black text-white text-lg py-4'>
      <div className='flex flex-wrap items-center justify-between mx-auto p-4'>
        ...
        <div className={`w-full  md:h-auto md:block md:w-auto md:p-2 md:p-0 ${isOpen ? 'drawer-open' : 'drawer-closed'}`}>
          <ul className='flex flex-col justify-evenly h-5/6 items-center mt-4 p-4 md:p-0 border border-gray-400 rounded-lg md:flex-row md:mt-0 md:border-0 md:bg-black drawer '>
            <li>
